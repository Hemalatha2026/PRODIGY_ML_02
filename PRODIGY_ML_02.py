...
data = pd.read_csv(r"C:\Users\ASUS\OneDrive\Desktop\Creditcard_clustering.csv")
data
...
features = ['BALANCE_FREQUENCY', 'PURCHASES', 'TENURE']
X = data[features]
...
plt.figure(figsize=(10, 6))
sns.scatterplot(data=data, x='CASH_ADVANCE_TRX', y= 'TENURE', hue='Cluster', palette='viridis')
